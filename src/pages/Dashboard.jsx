          ...
          {isLoading ? (
            ...
            <>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <StatCard label="Total Projects" count={totalProjects} color="border-blue-500" />
                <StatCard label="In Progress"    count={countByStatus("IN_PROGRESS")} color="border-yellow-400" />
                <StatCard label="Completed"      count={countByStatus("COMPLETED")}   color="border-green-500" />
                <StatCard label="On Hold"        count={countByStatus("ON_HOLD")}     color="border-gray-400" />
              </div>
